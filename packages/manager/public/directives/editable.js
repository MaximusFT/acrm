...
angular.module('mean.manager').directive('ngEnter', function() {
...
angular.module('mean.manager').directive('ngEditable', function() {
    return {
...
angular.module('mean.manager').directive('ngEditableParagraph', function() {
    return {
        // can be in-lined or async loaded by xhr
        // or inlined as JS string (using template property)
...
angular.module('mean.manager').directive('ngEditableSelect', function() {
    return {
