...
angular.module('mean.mean-admin').directive('ngEditable', function() {
    return {
        ...
        template: '<span class="editable-wrapper">' + '<span data-ng-hide="edit" data-ng-dblclick="edit=true;value=model;">{{model === "" || !model ? "---" : model}}</span>' + '<input type="text" data-ng-model="value" data-ng-blur="edit = false; model = value" data-ng-show="edit" data-ng-enter="model=value;edit=false;" style="width:100%;"  />' + '</span>',
        scope: {
