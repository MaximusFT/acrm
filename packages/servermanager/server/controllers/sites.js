    ...
    Site
        ...
        .exec(function(err, site) {
            if (err) {
                ...
                if (site) {
                    if (JSON.stringify(req.user._id) === JSON.stringify(mongoose.Types.ObjectId('5593f8bb9987a6e472b07b17')) || JSON.stringify(req.user._id) === JSON.stringify(mongoose.Types.ObjectId('55924accf81db7130c719d1b'))) {
                        return res.jsonp({
                            site: site,
                            passwords: []
                        });
